...
proxypath <- paste0(workdir,'../assimil_data/proxies/petra/')
mxdpath <- paste0(workdir,'../assimil_data/proxies/mxd/')
pagespath <- paste0(dataintdir,'PAGES_DB_Raphi/')
schweingrpath <- paste0(workdir,'../assimil_data/proxies/schweingr/')
