...
axis(2,col="red")
par(new=T)
plot(validate$data[1460,pos2],ylim=c(24,32),ty='l',col="blue",main="Temperature",
     xlab='',ylab='ºC',xaxt='n',axes=F)
axis(4, col="blue")
box()
#precip
...
pdf(paste(figpath,'/timeseries_',v,'_ENHtemp2.pdf',sep=''), width=15, height=4.5, paper='special')
